...
#if !defined(_spatial_testsimpledbvolume_h)
#define _spatial_testsimpledbvolume_h
...
class spatial::TestSimpleDBVolume : public TestSimpleDB
{ // class TestSimpleDBVolume
...
#endif // _spatial_testsimpledbvolume_h

// version
// $Id: TestSimpleDBVolume.h,v 1.1.1.1 2005/03/17 22:18:34 baagaard Exp $
