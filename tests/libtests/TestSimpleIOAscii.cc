...
// ----------------------------------------------------------------------
CPPUNIT_TEST_SUITE_REGISTRATION( spatial::TestSimpleIOAscii );

// ----------------------------------------------------------------------
// Test Filename(), Write(), Read()
void
spatial::TestSimpleIOAscii::testIO(void)
{ // testIO
...
// version
// $Id: TestSimpleIOAscii.cc,v 1.1.1.1 2005/03/17 22:18:34 baagaard Exp $
