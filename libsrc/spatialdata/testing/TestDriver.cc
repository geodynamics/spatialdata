...
// ----------------------------------------------------------------------
// Constructor
spatialdata::testing::TestDriver::TestDriver() :
    _showHelp(false),
    _listTests(false) {}
...
// ---------------------------------------------------------------------------------------------------------------------
// Destructor
spatialdata::testing::TestDriver::~TestDriver(void) {}
...
void
spatialdata::testing::TestDriver::_printHelp(void) {
 ...
 */
void
spatialdata::testing::TestDriver::_printTests(const CppUnit::Test* const test) {
    if (!test) { return; }
