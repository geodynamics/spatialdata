...
/**
 * @file libsrc/testing/TestDriver.hh
 *
 * @brief Object for running C++ tests.
 */

#if !defined(spatialdata_testing_testdriver_hh)
#define spatialdata_testing_testdriver_hh

#include "spatialdata/testing/testingfwd.hh" // forward declaration
...
class spatialdata::testing::TestDriver {
    // PUBLIC METHODS //////////////////////////////////////////////////////////////////////////////////////////////////
public:
...
#endif // spatialdata_testing_testdriver_hh
