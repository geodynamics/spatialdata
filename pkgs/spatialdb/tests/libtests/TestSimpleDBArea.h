...
#if !defined(spatialdata_testsimpledbarea_h)
#define spatialdata_testsimpledbarea_h
...
class spatialdata::TestSimpleDBArea : public TestSimpleDB
{ // class TestSimpleDBArea
...
#endif // spatialdata_testsimpledbarea_h
